...
class AssignmentGradesControllerTest < ActionController::TestCase
  ...
  test "should create assignment_grade" do
    assert_difference('AssignmentGrade.count') do
      post :create, assignment_grade: { assignment_name: @assignment_grade.assignment_name, grade: @assignment_grade.grade, student_id: @assignment_grade.student_id }
    end
  ...
  test "should update assignment_grade" do
    patch :update, id: @assignment_grade, assignment_grade: { assignment_name: @assignment_grade.assignment_name, grade: @assignment_grade.grade, student_id: @assignment_grade.student_id }
    assert_redirected_to assignment_grade_path(assigns(:assignment_grade))
  end
